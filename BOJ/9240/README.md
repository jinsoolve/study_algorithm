## [백준 9240 - 로버트 후드](https://www.acmicpc.net/problem/9240)

### 풀이
Convex Hull Algorithm으로 푸는 문제다.
1. 볼록 껍질들을 찾는다.
2. 볼록 껍질들끼리의 거리를 모두 측정해 그 중 가장 큰 값이 정답이다.  
   볼록 껍질의 점들은 최악의 경우 2000 * 4 = 8000 이므로 제곱을 해도 약 $6 * 10^7$이다.

### 주의
cmp 함수를 만들 때 ccw = 0 일 경우 거리를 비교해 줘야 한다.
